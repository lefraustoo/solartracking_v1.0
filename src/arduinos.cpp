...
void ServoMovement()
{
    ...
    Serial.print("| lt: " + String(lt) + " | rt: " + String(rt) + " | ld: " + String(ld) + " | rd: " + String(rd) + " |");
    ArduinoSlave.print("| lt: " + String(lt) + " | rt: " + String(rt) + " | ld: " + String(ld) + " | rd: " + String(rd) + " |");
    ...
    Serial.println("| veg: " + String(veg) + " | tol: " + String(tol) + " | dtime: " + String(dtime) + " |");
    ArduinoSlave.println("| veg: " + String(veg) + " | tol: " + String(tol) + " | dtime: " + String(dtime) + " |");
...
void INA226multimeter()
{
    ...
    Serial.println("| Shunt Voltage [mV]: " + String(shuntVoltage_mV) + " | Bus Voltage [V]: " + String(busVoltage_V) + " | Load Voltage [V]: " + String(loadVoltage_V) + " | Current[mA]: " + String(current_mA) + " | Bus Power [mW]: " + String(power_mW) + " |");
    ArduinoSlave.println("| Shunt Voltage [mV]: " + String(shuntVoltage_mV) + " | Bus Voltage [V]: " + String(busVoltage_V) + " | Load Voltage [V]: " + String(loadVoltage_V) + " | Current[mA]: " + String(current_mA) + " | Bus Power [mW]: " + String(power_mW) + " |");
